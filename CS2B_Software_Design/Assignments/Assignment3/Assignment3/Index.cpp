...
// Revisions history: No changes, Version 1
//=====================================================================================
...
Townhouse::Townhouse() :HOA_monthly_fee_(100.0), Property(){}
...
SingleFamilyHouse::SingleFamilyHouse() :backyard_area_(0.00), Property(){}
...
PropertyList::~PropertyList() {
	//ust use another pointer to get next as p_home is deleted
	Property * p_home;
	p_home = head_;
	while (p_home != NULL) {
		delete p_home;
